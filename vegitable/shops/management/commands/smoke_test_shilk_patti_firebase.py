...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            type=int,
            default=999994,
            help='Temporary shop_id to use for the Firebase Shilk patti smoke test.',
        )
    ...
    def handle(self, *args, **options):
        ...
        if not arrival_repository.using_firebase() or not sales_repository.using_firebase() or not credit_repository.using_firebase() or not patti_repository.using_firebase():
            raise CommandError(
                'Set FIREBASE_ENABLED=True, USE_FIREBASE_ARRIVAL=True, USE_FIREBASE_SALES=True, USE_FIREBASE_CREDIT=True, and USE_FIREBASE_PATTI=True before running this command.'
            )
